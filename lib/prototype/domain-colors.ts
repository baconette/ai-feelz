 ...
 * underline, domain slider label). Values reference the color/chart ramp tokens
 * defined in globals.css.
 */
export const DOMAIN_COLORS: Record<
  string,
  { marqueeUnderline: string; badge: string; sentenceUnderline: string; domainText: string }
> = {
  Healthcare: {
    ...
    domainText: 'text-[color:var(--color-chart-red-700)]',
  },
  Productivity: {
    marqueeUnderline: 'decoration-[color:var(--color-chart-orange-400)]',
    ...
    domainText: 'text-[color:var(--color-chart-orange-700)]',
  },
  Mobility: {
    marqueeUnderline: 'decoration-[color:var(--color-chart-amber-400)]',
    ...
    domainText: 'text-[color:var(--color-chart-amber-700)]',
  },
  Robotics: {
    marqueeUnderline: 'decoration-[color:var(--color-chart-lime-400)]',
    badge: 'bg-[color:var(--color-chart-lime-100)] text-[color:var(--color-chart-lime-700)]',
    sentenceUnderline: 'decoration-[color:var(--color-chart-lime-100)]',
    domainText: 'text-[color:var(--color-chart-lime-700)]',
  },
  Finances: {
    marqueeUnderline: 'decoration-[color:var(--color-chart-emerald-400)]',
    ...
    domainText: 'text-[color:var(--color-chart-emerald-700)]',
  },
  Education: {
    marqueeUnderline: 'decoration-[color:var(--color-chart-cyan-400)]',
    ...
    domainText: 'text-[color:var(--color-chart-cyan-700)]',
  },
  'Legal & Public Services': {
    ...
    domainText: 'text-[color:var(--color-chart-blue-700)]',
  },
  'Home & Personal Life': {
    ...
    domainText: 'text-[color:var(--color-chart-violet-700)]',
  },
  'Leisure & Hospitality': {
    ...
    domainText: 'text-[color:var(--color-chart-magenta-700)]',
  },
  'Media & Culture': {
    ...
    domainText: 'text-[color:var(--color-chart-pink-700)]',
  },
}
...
export const DEFAULT_DOMAIN_TEXT_CLASSES = 'text-foreground'
